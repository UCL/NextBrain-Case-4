# NextBrain: Case 4
This repository contains data that is consumed by the [NextBrain project](https://github.com/UCL/NextBrain). This data corresponds to case 4. For the source code of this project refer to the main [NextBrain repo](https://github.com/UCL/NextBrain).
...
![alt text](https://github.com/UCL/NextBrain-Case-4/blob/main/mri2histo.svg?raw=true)
